...
class Cylinder(Shape):
    ...
    while True:
        ...
        if choice == 1:
            ...
            cylinder_input1=int(input("enter the radius of cylinder (in cm):- "))
            cylinder_input2=int(input("enter the height of cylinder (in cm):- "))
            cylinder = Cylinder(cylinder_input1, cylinder_input2)
            """ gave both inputs to cylinder"""
